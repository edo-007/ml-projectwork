...
from src.utils import RESS_DIR, get_embeddings, Colors, load_dataset
from src.models import get_model_and_grid, get_parametrized_estimator, MODEL_REGISTRY
...
def plot_learning_curves(results, relative_train_sizes, output_dir=RESS_DIR):
    """
    ...
    for metric in metrics:
        ...
        for model_name, model_results in results.items():
            ...
            plt.plot(sizes, scores, marker='o', linewidth=1.5, 
                     label=model_name.upper(), markersize=5)
...
def save_results_json(results, output_dir=RESS_DIR):
    """
