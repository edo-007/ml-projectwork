...
# Sottocartelle (tutte dentro DATA_DIR)
DATS_DIR = os.path.join(DATA_DIR, 'datasets')
EMBS_DIR = os.path.join(DATA_DIR, 'embeddings')
RESS_DIR = os.path.join(DATA_DIR, 'results')
MODS_DIR = os.path.join(DATA_DIR, 'models')
...
def load_dataset(data_name):
    ...
    data_path = os.path.join(DATS_DIR, data_name)
    """
...
def get_embeddings(args):
    ...
    embeddings_file = f"{EMBS_DIR}/{Path(args.data).stem}.joblib"
